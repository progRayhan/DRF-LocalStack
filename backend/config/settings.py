...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'drflocalstackdb'),
        'USER': os.environ.get('POSTGRES_USER', 'drflocalstackuser'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'drflocalstackpassword'),
